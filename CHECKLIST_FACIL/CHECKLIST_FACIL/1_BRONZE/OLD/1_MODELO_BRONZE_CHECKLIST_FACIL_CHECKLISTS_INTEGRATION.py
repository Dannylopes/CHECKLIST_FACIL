...
# MAGIC %md
# MAGIC ### *Notebook de Ingestão da tabela '**checklistfacil_checklists**'*
# MAGIC | Camada      | Domínio     | Entidade    |
# MAGIC | ----------  | ----------  | ----------  |
# MAGIC | Corp     | cvc_corp_work (Bronze)     | checklistfacil_checklists     |
# MAGIC
# MAGIC
...
BASE_URL = "https://integration.checklistfacil.com.br/v2/"
endpoint = "checklists"
