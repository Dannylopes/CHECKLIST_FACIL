...
# MAGIC %md
# MAGIC ### *Notebook de Ingestão Camada Bronze da tabela '**checklistfacil_evaluations_departments**'*
# MAGIC | Camada      | Domínio     | Entidade    |
# MAGIC | ----------  | ----------  | ----------  |
# MAGIC | Corp     | cvc_corp_work (Bronze)     | checklistfacil_evaluations_departments    |
# MAGIC
# MAGIC
...
endpoint = "evaluations/departments"
