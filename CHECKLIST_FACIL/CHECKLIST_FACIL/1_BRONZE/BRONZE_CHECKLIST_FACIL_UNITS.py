...
# MAGIC %md
# MAGIC ### *Notebook de Ingestão da tabela '**checklistfacil_units**'*
# MAGIC | Camada      | Domínio     | Entidade    |
# MAGIC | ----------  | ----------  | ----------  |
# MAGIC | Corp     | cvc_corp_work (Bronze)     | checklistfacil_units     |
# MAGIC
# MAGIC
...
# df_gravado = spark.sql(f"SELECT * FROM {TABLE_NAME}")
# display(df_gravado)